...
largura = float(input("Para começar, digite a largura da parede em metros:\n")) 
altura = float(input("Digite a altura da parede em metros:\n"))
area = largura * altura
quantidade_tinta = area / 2
quantidade_meia_parede = area / 4
print("A área da parede é: {:.2f} m²".format(area))
print("A quantidade de tinta necessária é: {:.2f} litros".format(quantidade_tinta))
print("A quantidade de tinta necessária para pintar metade da parede é: {:.2f} litros".format(quantidade_meia_parede))
